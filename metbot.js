/**
 * ui-bot
 * An IRC bot for irc.freenode.net/meteor
 * Inspured by ui-bot from ProLoser at: https://github.com/angular-ui/ui-bot
 * @license MIT
 */
...
//  , config = require('./config.js')
  , options = { server: 'irc.freenode.net'
              ...
              , user: { username: 'met-bot'
                      , realname: 'Meteor Bot'
                      }
              };
// Setup Mongo
mongoose.connect("mongodb://username:pass@host:27017/dbname");
...
jerk(function (j)
{
  ...
  // !forget [nonSpace]
  j.watch_for(/meet met-bot/i, function (message)
  {
    message.say('well hello there ' + message.user + ' ... nice pants');
  })
